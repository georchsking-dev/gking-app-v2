...
export const themeLogoFontFamilyCss = cinzel.style.fontFamily;
  ...
  colorSchemes: {
    ...
    dark: {
      palette: {
        ...
        background: {
          // New
          popup: '#0b0b0e', // Deep black popup background
          surface: '#020204', // Black surface
          level1: '#09090c',
          level2: '#121217',
          body: '#020204', // Deep black background
